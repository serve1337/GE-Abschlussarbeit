...
(function Renderer$Members () {
  ...
  function Renderer__ctor (rc) {
    ...
    this.SpecFactorParam = (this.RC).GetShaderParam(shaderProgram, "specfactor");
    this.SpecColorParam = (this.RC).GetShaderParam(shaderProgram, "speccolor");
    this.AmbientColorParam = (this.RC).GetShaderParam(shaderProgram, "ambientcolor");
  }; 
  ...
  function Renderer_OnMaterial (material) {
    ...
    if (hasDiffuse) {
      ...
      (this.RC).SetShaderParam3f(this.AlbedoParam, $T0C().Zero.MemberwiseClone());
    }
    var hasSpecular = material.get_HasSpecular();
    if (hasSpecular) {
      (this.RC).SetShaderParam1f(this.ShininessParam, material.Specular.Shininess);
      (this.RC).SetShaderParam1f(this.SpecFactorParam, material.Specular.Intensity);
      (this.RC).SetShaderParam3f(this.SpecColorParam, material.Specular.Color.MemberwiseClone());
    } else {
      (this.RC).SetShaderParamI(this.ShininessParam, 0);
      (this.RC).SetShaderParamI(this.SpecFactorParam, 0);
      (this.RC).SetShaderParam3f(this.SpecColorParam, $T0C().Zero.MemberwiseClone());
    }
    var hasEmissive = material.get_HasEmissive();
    if (hasEmissive) {
      (this.RC).SetShaderParam3f(this.AmbientColorParam, material.Emissive.Color.MemberwiseClone());
    } else {
      (this.RC).SetShaderParam3f(this.AmbientColorParam, $T0C().Zero.MemberwiseClone());
    }
  }; 
  ...
  function Renderer_OnTransform (xform) {
    this._model.Tos = $S01().CallStatic($T07(), "op_Multiply", null, this._model.Tos.MemberwiseClone(), $T0E().Matrix(xform).MemberwiseClone()).MemberwiseClone();
